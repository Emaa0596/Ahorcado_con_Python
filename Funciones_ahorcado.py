...
tarima = pygame.image.load(r"Ahorcado\img\tarima.png")
tarima = pygame.transform.scale(tarima,(250,350))
cabeza = pygame.image.load(r"Ahorcado\img\cabeza.png")
cabeza = pygame.transform.scale(cabeza,(90,75))
soga = pygame.image.load(r"Ahorcado\img\soga.png")
soga = pygame.transform.scale(soga,(25,32))
cuerpo = pygame.image.load(r"Ahorcado\img\cuerpo.png")
cuerpo = pygame.transform.scale(cuerpo,(50,75))
brazo_derecho = pygame.image.load(r"Ahorcado\img\brazo derecha.png")
brazo_derecho = pygame.transform.scale(brazo_derecho,(40,60))
brazo_izquierdo = pygame.transform.flip(brazo_derecho,True,False)
icono_ahorcado = pygame.image.load(r"Ahorcado\img\icono_ahorcado.jpeg")
icono_ahorcado = pygame.transform.scale(icono_ahorcado,(30,30))
fondo = pygame.image.load(r"Ahorcado\img\fondo.jpg")
fondo = pygame.transform.scale(fondo,TAMAÑO_PANTALLA)

teclado_pantalla = pygame.image.load(r"Ahorcado\img\teclado_final.png")
...
icono_x = pygame.image.load(r"Ahorcado\img\x.png")
